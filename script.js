...
if(c>=5){
    ...
    if(a[0].innerHTML=='X') { c1.innerHTML='User 1 Wins'; e=0;   setTimeout(()=>{clr()},1000);}
    if(a[0].innerHTML=='O') { c1.innerHTML='User 2 Wins'; e=0;  setTimeout(()=>{clr()},1000);}
   
    }
   else if(a[3].innerHTML==a[4].innerHTML&&a[4].innerHTML==a[5].innerHTML){
        if(a[3].innerHTML=='X'){c1.innerHTML='User 1 Wins'; e=0; setTimeout(()=>{clr()},1000);}
        if(a[3].innerHTML=='O'){c1.innerHTML='User 2 Wins'; e=0; setTimeout(()=>{clr()},1000);}
    }
   else if(a[6].innerHTML==a[7].innerHTML&&a[7].innerHTML==a[8].innerHTML){
        if(a[6].innerHTML=='X'){c1.innerHTML='User 1 Wins'; e=0; setTimeout(()=>{clr()},1000);}
        if(a[6].innerHTML=='O'){c1.innerHTML='User 2 Wins'; e=0; setTimeout(()=>{clr()},1000);}
    }
        ...
        if(a[1].innerHTML=='X'){c1.innerHTML='User 1 Wins';e=0; setTimeout(()=>{clr()},1000);}
        if(a[1].innerHTML=='O'){c1.innerHTML='User 2 Wins';e=0; setTimeout(()=>{clr()},1000);}
    }
    else if(a[2].innerHTML==a[5].innerHTML&&a[5].innerHTML==a[8].innerHTML){
        if(a[2].innerHTML=='X') {c1.innerHTML='User 1 Wins'; e=0; setTimeout(()=>{clr()},1000);}
        if(a[2].innerHTML=='O') {c1.innerHTML='User 2 Wins'; e=0; setTimeout(()=>{clr()},1000);}
    }
